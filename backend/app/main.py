...
from app.domains.marketing_insights.router import router as marketing_insights_router
...
app.include_router(marketing_insights_router, prefix="/api/v1/products", tags=["marketing-insights"])
